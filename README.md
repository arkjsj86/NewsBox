...
<p align="center">
  4개의 고정 탭으로 한국어 AI, Unity, 게임, 연예 뉴스를 빠르게 훑어보는 정적 큐레이션 프로젝트
</p>
...
NewsBox는 `AI`, `Unity`, `게임`, `연예` 4개 탭을 중심으로 한국어 뉴스를 한곳에서 빠르게 확인할 수 있게 만든 프로젝트다.
...
NewsBox는 한국어 AI, Unity, 게임, 연예 뉴스를 탭별로 모아 중복을 줄이고 정적 JSON으로 배포하는 뉴스 큐레이션 프로젝트다.
